...
namespace UnityEditor.XR.Interaction.Toolkit
{
    ...
    internal class XRDirectInteractorEditor : Editor
    {
        ...
        {
            // Start modification by Maiko...
            public static readonly GUIContent controller = new GUIContent("XR Controller", "The controller this interactor is attached to (will find the one on this GameObject if none is set).");
            // End modification by Maiko!
